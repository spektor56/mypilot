...
class CarInterfaceBase(ABC):
  ...
  def create_common_events(self, cs_out, extra_gears=None, pcm_enable=True, allow_enable=True):
    ...
    if cs_out.gearShifter != GearShifter.drive and (extra_gears is None or cs_out.gearShifter not in extra_gears) and not (cs_out.gearShifter == GearShifter.unknown and self.gear_warning < int(0.5/DT_CTRL)):
